            ...
            <AnimateOnScroll variant="fade-up">
              <div className="mt-12">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    { href: "/dax-guide", icon: Calculator, title: "DAX Functions Guide", description: "Master DAX functions to create powerful calculations on your data models." },
                    { href: "/measures-vs-columns", icon: Columns3, title: "Measures vs Columns", description: "Understand when to use measures vs calculated columns in your models." },
                    { href: "/data-visualization", icon: BarChart3, title: "Data Visualization", description: "Bring your data models to life with charts, dashboards, and visual design." },
                    { href: "/sql-reference", icon: Table2, title: "SQL Reference", description: "Bridge your SQL knowledge to Power BI with side-by-side query patterns." },
                  ].map((item) => {
